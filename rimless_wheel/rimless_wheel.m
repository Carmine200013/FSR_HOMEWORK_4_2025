...
% Initial conditions
w_1 = sqrt((2*g/l)*(1 - cos(gamma - alpha)));
...
folderPath = 'C:\Users\maist\Desktop\Università\Magistrale\Field_And_Service_Robotics\Homework_4\plots_rimless_wheel';


% Plot results
p1 = figure('Renderer','painters');
...
legend show;
grid on;
%exportgraphics(p1, fullfile(folderPath, 'Rimless_Wheel_Dynamics_l18_alphapi6_gamma018.pdf'));

p2 = figure('Renderer','painters');
...
legend show;
grid on;
%exportgraphics(p2, fullfile(folderPath, 'Rimless_Wheel_Limit_Cycle_l18_alphapi6_gamma018.pdf'));
